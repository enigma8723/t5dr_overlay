...
struct T5DRAddresses {
	...
	uint16_t t5_moveset_toc_cancels_adress_offset = 0x198; // ??? doesn't seem to be correct
	uint16_t t5_moveset_toc_extra_props_adress_offset = 0x1BC; //0x1C8;  ??? doesn't seem to be correct
};